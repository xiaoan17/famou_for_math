"""
Population Size Ablation Study

Tests the effect of different population sizes on evolutionary performance.
...
if __name__ == "__main__":
    ...
    print("Population Size Ablation - Base Solution Test:")
