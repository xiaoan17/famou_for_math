"""
Migration Interval Ablation Study

Tests the effect of different migration intervals on evolutionary performance.
...
if __name__ == "__main__":
    ...
    print("Migration Interval Ablation - Base Solution Test:")
